# -*-coding:utf-8-*-
# from config_MSRvid_hcti import opt
from config_MSRvid_lstm import opt
...
def train(**kwargs):
    ...
    for epoch in range(opt.max_epoch):
        ...
        print('epoch: %d' %epoch)
        print('test pesrson: ' + str(test_pearsonr))
...
if __name__ == '__main__':
    ...
    # fire.Fire()
    test, ind = train()
    print('best test pearson: ' + str(test)+'in epoch %d' %ind)
